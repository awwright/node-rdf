...
function graphifyObject(aliasmap){
	...
	function graphify(s1,p1,o1) {
		...
		if(Array.isArray(o1) || o1['$list'] || o1['@list']) {
			...
			graph.add( env.createTriple(s1n, expandprop(p1,profile), exports.Number.toRDFNode.call(o1) ) );
		} else if(typeof o1=='boolean') {
			graph.add( env.createTriple(s1n, expandprop(p1,profile), exports.Boolean.toRDFNode.call(o1) ) );
		} else {
