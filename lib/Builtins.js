...
var BooleanProperties = {
	datatype: _( prof.resolve("xsd:boolean") ),
...
// Date
var DateProperties = {
	datatype: _( prof.resolve("xsd:dateTime") ),
	value: _getter(function(){return this;}),
	nodeType: _( function() { return "TypedLiteral"} ),
	n3: _( function() {
...
var NumberProperties = {
	datatype: {
		...
		get: function() {
			...
			if(isNaN(this)) return prof.resolve('xsd:double');
			var n = this.toString();
	...
	toNT: _( function() {
		if(this == Number.POSITIVE_INFINITY) return '"INF"^^<' + prof.resolve('xsd:double') + '>';
		if(this == Number.NEGATIVE_INFINITY) return '"-INF"^^<' + prof.resolve('xsd:double') + '>';
		if(isNaN(this)) return '"NaN"^^<' + prof.resolve('xsd:double') + '>';
