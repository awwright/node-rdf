...
function n3(value, profile){
	...
	if(typeof value=='string') return exports.StringProperties.n3.value.call(value, profile);
	if(typeof value=='number') return exports.NumberProperties.n3.value.call(value, profile);
	if(typeof value=='boolean') return exports.BooleanProperties.n3.value.call(value, profile);
	if(value instanceof Date) return exports.DateProperties.n3.value.call(value, profile);
		...
		n3: _( function toN3(aliasmap, padding) {
			...
			Object.keys(this).forEach(function toN3_property(p) {
				...
				if(typeof val=='string'){
					...
					// If the value is an IRI, or an object without an IRI, recurse
					outs.push( predicateString + ' ' + n3(val, profile) );
					return;
				...
				if(val && val.nodeType && typeof val.nodeType == 'IRI'){
					outs.push( predicateString + ' ' + val.n3(profile) );
					return;
