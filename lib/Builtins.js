...
exports.setBuiltins = function setBuiltins(){
	...
	setOn(ObjectProperties, Object.prototype);
	setOn(StringProperties, String.prototype);
	setOn(ArrayProperties, Array.prototype);
	setOn(BooleanProperties, Boolean.prototype);
	setOn(DateProperties, Date.prototype);
	setOn(NumberProperties, Number.prototype);
...
exports.unsetBuiltins = function unsetBuiltins(){
	...
	unsetOn(ObjectProperties, Object.prototype);
	unsetOn(StringProperties, String.prototype);
	unsetOn(ArrayProperties, Array.prototype);
	unsetOn(BooleanProperties, Boolean.prototype);
	unsetOn(DateProperties, Date.prototype);
	unsetOn(NumberProperties, Number.prototype);
}
