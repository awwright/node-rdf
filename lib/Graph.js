...
api.TripletGraph.prototype.add = function(triple) {
	...
	if(this.match(triple.subject, triple.predicate, triple.object).length) return;
...
api.TripletGraph.prototype.remove = function(triple) {
	if(this.match(triple.subject, triple.predicate, triple.object).length==0) return;
...
api.TripletGraph.prototype.removeMatches = function(s, p, o) {
	var graph = this;
...
api.TripletGraph.prototype.filter = function filter(cb){
	var result = new api.TripletGraph;
...
api.TripletGraph.prototype.equals = function equals(b){
	return GraphEquals(this, b);
}

//api.TripletGraph.prototype.addAction = function(action, run){
...
//}
//
//Object.defineProperty(api.TripletGraph.prototype, 'actions', { get: function(){ return this._actions; } });
