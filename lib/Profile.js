...
// FIXME use a Map or something here, otherwise PrefixMap#set('get') will cause problems
...
api.PrefixMap.prototype.addAll = function(prefixes, override){
	if(override){
		for(var n in prefixes) if(Object.hasOwnProperty.call(prefixes, n)) this.set(n, prefixes[n]);
	}else{
		for(var n in prefixes) if(Object.hasOwnProperty.call(prefixes, n) && !Object.hasOwnProperty.call(this, n)) this.set(n, prefixes[n]);
	}
}
...
api.TermMap.prototype.addAll = function(terms, override){
	if(override){
		for(var n in terms) if(Object.hasOwnProperty.call(terms, n)) this.set(n, terms[n]);
	}else{
		for(var n in terms) if(Object.hasOwnProperty.call(terms, n) && !Object.hasOwnProperty.call(this, n)) this.set(n, terms[n]);
	}
}
