...
exports.RDFEnvironment.prototype.createLiteral = function(value, datatype, _dt){
	...
	if(datatype!==undefined && datatype!==null && typeof datatype!=='string') throw new TypeError('Expected optional argument[1] `datatype` to be a string');
	if(_dt!==undefined && _dt!==null && typeof _dt!=='string') throw new TypeError('Expected optional argument[2] `_dt` to be a string');
	if(typeof datatype=='string' && (_dt==null || _dt==undefined || _dt=='http://www.w3.org/1999/02/22-rdf-syntax-ns#langString')){
		// Process arguments as a language literal
		return new Literal(value, datatype);
	}else if(typeof _dt=='string'){
		return new Literal(value, _dt);
	}
