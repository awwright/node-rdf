...
api.Triple.prototype.equals = function(t) { return this.subject.equals(t.subject) && this.predicate.equals(t.predicate) && this.object.equals(t.object) }

/**
 * Implements RDFNode http://www.w3.org/TR/2011/WD-rdf-interfaces-20110510/#idl-def-RDFNode
 */
api.RDFNode = function() {};
api.RDFNode.prototype.equals = function RDFNodeEquals(other) {
...
api.RDFNode.prototype.encodeString = function(s) {
	var out = "";
	var skip = false;
...
api.BlankNode.prototype.valueOf =  function() { return "_:"+this.value; }
