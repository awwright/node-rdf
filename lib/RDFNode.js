...
api.Triple.prototype = {
	size: 3, length: 3,
	toString: function() { return this.subject.toNT() + " " + this.predicate.toNT() + " " + this.object.toNT() + " ." },
	equals: function(t) { return this.subject.equals(t.subject) && this.predicate.equals(t.predicate) && this.object.equals(t.object) }
};
...
api.BlankNode = function(id) {
	if(id.substr(0,2)=='_:') this.value=id.substr(2);
	else if(id) this.value=id;
	else this.value = "_:b" + (++api.BlankNode.NextId).toString();
};
api.BlankNode.NextId = 0;
api.BlankNode.prototype = new api.RDFNode;
api.BlankNode.prototype.nodeType = function() { return "BlankNode"; },
api.BlankNode.prototype.toNT = function() { return this.value; }
...
require('./DefaultDataContext.js').loadDefaultTypeConverters(api.Literal);
