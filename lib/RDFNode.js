...
api.Triple = function Triple(s, p, o) {
	if(!(s instanceof api.RDFNode)) throw new Error('Triple subject is not an RDFNode');
	if(!(p instanceof api.RDFNode)) throw new Error('Triple predicate is not an RDFNode');
	if(!(o instanceof api.RDFNode)) throw new Error('Triple object is not an RDFNode');
	this.subject = s;
	this.predicate = p;
	this.object = o;
};
...
api.NamedNode = function NamedNode(iri) {
	if(typeof iri!='string') throw new Error('IRI not a string');
