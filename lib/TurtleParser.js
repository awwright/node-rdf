	...
	switch(s.charAt(0)) {
		...
		case "^":
			...
			if(s.charAt(0) == "<"){
				...
				var iri_val = env.createNamedNode(this.base.resolveReference(parsers.decodeIRIREF(iri_esc)).toString());
				...
				var iri_val = this.environment.resolve(parsers.decodePrefixedName(prefixedName));
			...
			o.o = env.createLiteral(value, null, iri_val);
			break;
		default:
