...
var RDFEnvironment = new require('./RDFEnvironment.js').RDFEnvironment;
var prof = require("./Builtins.js").environment;
function i(v){require('util').inspect(v,true,null,true);}
...
parsers.Turtle.prototype = {
	...
	consumeCollection: function(s, subject) {
		...
		while(cont) {
			...
			cont = s.charAt(0) != ")";
			if(cont) {
				this.add(new Triple(listject.o, prof.resolve("rdf:rest"), listject.o = new BlankNode))
			} else {
