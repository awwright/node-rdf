...
api.Profile = require('./DataContext.js').Profile;
api.context = String.prototype.profile = new api.Profile;
require('./DefaultDataContext.js').loadDefaultPrefixMap(api.context);
